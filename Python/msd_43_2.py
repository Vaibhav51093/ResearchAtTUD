...
def smooth_msd(path_line='dump_nvt_prod.out',file_2='msd_na.txt',step=1.0, dump_write=100, step_ovito=10):
   ...
   # 
    ...
    columns=["Timestep", "MSDx_bulk_com", "MSDy_bulk_com", "MSDz_bulk_com", "MSDxy_bulk_com", "MSDxz_bulk_com", "MSDyz_bulk_com", "netMSDx_bulk_com", "netMSDy_bulk_com", "netMSDz_bulk_com", "netMSDxy_bulk_com", "netMSDxz_bulk_com", "netMSDyz_bulk_com", "MSDav_bulk_com", "netMSDav_bulk_com"],multiple_frames=True)
...
no = [43,43,43,43,43,43]

#file_paths = ["/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_523k/dump_nvt_prod.out.tar.gz",
#               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_573k/dump_nvt_prod.out.tar.gz",
#               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_623k/dump_nvt_prod.out.tar.gz",
#               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_673k/dump_nvt_prod.out.tar.gz",
#               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_723k/dump_nvt_prod.out.tar.gz",
#               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_773k/dump_nvt_prod.out.tar.gz",]
...
input_files = ["/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_523k/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_573k/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_623k/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_673k/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_723k/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_1/glass/hena_1_glass/glass_43_773k/dump_nvt_prod.out",]
...
for i,j,k in zip(li,input_files,no):
    ...
    print('------------------------------------------------------------------------------------------------------------------')
    smooth_msd(path_line=j,file_2='msd_na_hena_1_amorph_%s_%s.txt'%(i,k),step=2.0, dump_write=200, step_ovito=1)
    print('-----------------------------------------------Next calc----------------------------------------------------------')
    #smooth_msd(path_line=j,file_2='msd_na_523_tensor_crystal_msd_smooth_3.txt',step=1.0, dump_write=100, step_ovito=10)
