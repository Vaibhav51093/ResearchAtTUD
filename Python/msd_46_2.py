...
#file_paths = [
#    "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_523k_46_hdf5/hena_1_struct_eq_523k_46/hena_1_struct_eq_523k_46.tar.bz2",
#    "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_573k_46_hdf5/hena_1_struct_eq_573k_46/hena_1_struct_eq_573k_46.tar.bz2",
#    "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_623k_46_hdf5/hena_1_struct_eq_623k_46/hena_1_struct_eq_623k_46.tar.bz2",
#    "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_673k_46_hdf5/hena_1_struct_eq_673k_46/hena_1_struct_eq_673k_46.tar.bz2",
#    "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_723k_46_hdf5/hena_1_struct_eq_723k_46/hena_1_struct_eq_723k_46.tar.bz2",
#    "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_773k_46_hdf5/hena_1_struct_eq_773k_46/hena_1_struct_eq_773k_46.tar.bz2"
#]
...
input_files = ["/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_523k_46_hdf5/hena_1_struct_eq_523k_46/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_573k_46_hdf5/hena_1_struct_eq_573k_46/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_623k_46_hdf5/hena_1_struct_eq_623k_46/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_673k_46_hdf5/hena_1_struct_eq_673k_46/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_723k_46_hdf5/hena_1_struct_eq_723k_46/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_1/minimization/hena_1_struct_eq_773k_46_hdf5/hena_1_struct_eq_773k_46/dump_nvt_prod.out",]
...
for i,j,k in zip(li,input_files,no):
    ...
    for e in range(0,pipeline.source.num_frames,pipeline.source.num_frames//d):
        if e+pipeline.source.num_frames//5 > pipeline.source.num_frames:
            ...
            print('------------------------------------------------------------------------------------------------------------------')
            smooth_msd(path_line=j,file_2='msd_na_hena_2_%s_%s_%s_%s.txt'%(i,k,m,n),step=2.0, dump_write=200, step_ovito=1, m=m, n=n)
            print('-----------------------------------------------Next calc----------------------------------------------------------')
            print('---------------------------------------------------------------------------------------------------------------------')
