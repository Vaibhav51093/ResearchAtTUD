...
def smooth_msd(path_line='dump_nvt_prod.out',file_2='msd_na.txt',step=1.0, dump_write=100, step_ovito=10,m=0,n=1000):
    ...
    def modify1(frame: int, data: DataCollection):
        ...
        charge_dict = {"Si": 2.4, "Zr": 2.4, "O":-1.2, "Na":0.6}     # Padone charges 
        mass_dict = {"Zr": 91.224,
                        "Si": 28.086,
                        "O": 15.999,
                        "Na": 22.99}
...
input_files = ["/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/nasi_3/523/dump_nvt_prod_4.out",
               "/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/nasi_3/573/dump_nvt_prod_4.out",
               "/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/nasi_3/623/dump_nvt_prod_4.out",
               "/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/nasi_3/673/dump_nvt_prod_4.out",
               "/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/nasi_3/723/dump_nvt_prod_4.out",
               "/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/nasi_3/773/dump_nvt_prod_4.out",]
...
for i,j,k in zip(li,input_files,no):
    ...
    for e in range(0,pipeline.source.num_frames,pipeline.source.num_frames//d):
        if e+pipeline.source.num_frames//5 > pipeline.source.num_frames:
            ...
            print('------------------------------------------------------------------------------------------------------------------')
            smooth_msd(path_line=j,file_2='msd_na_nasi_%s_%s_%s_%s.txt'%(i,k,m,n),step=2.0, dump_write=200, step_ovito=1, m=m, n=n)
            print('-----------------------------------------------Next calc----------------------------------------------------------')
            print('---------------------------------------------------------------------------------------------------------------------')
