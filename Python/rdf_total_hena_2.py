...
# Glass
pipeline_3 = import_file("/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_2/glass/glass_hena_2/glass_6_623/dump_nvt_prod.out")

# Crystal
pipeline_2 = import_file("/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_2/minimization/hena_2_2/hena_1_struct_eq_big_623k_6/dump_nvt_prod.out")
...
pipeline_3.modifiers.append(CoordinationAnalysisModifier(cutoff = 8.0, number_of_bins = 200, partial = False))
...
export_file(pipeline_3, "hena_2_big_glass_623k_total.txt", "txt/table", key="coordination-rdf[average]")
...
# Insert the RDF calculation modifier into the pipeline:
pipeline_2.modifiers.append(CoordinationAnalysisModifier(cutoff = 8.0, number_of_bins = 200, partial = False))
...
## Data export method 2: Use OVITO's own export function for DataTable objects:
export_file(pipeline_2, "hena_2_big_cryst_623k_total.txt", "txt/table", key="coordination-rdf[average]")
