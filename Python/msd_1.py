...
def smooth_msd(path_line='dump_nvt_prod.out.gz',file_2='msd_na.txt',step=1.0, dump_write=100, step_ovito=10,m=0,n=1000):
...
input_files = ["/nfshome/deshmukh/pyiron/projects/NASICON/project/new_glass/glass_523k_10_hdf5/glass_523k_10/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/new_glass/glass_573k_10_hdf5/glass_573k_10/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/new_glass/glass_623k_10_hdf5/glass_623k_10/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/new_glass/glass_673k_10_hdf5/glass_673k_10/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/new_glass/glass_723k_10_hdf5/glass_723k_10/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/new_glass/glass_773k_10_hdf5/glass_773k_10/dump_nvt_prod.out.gz",]
    ...
    for f in range(0, pipeline.source.num_frames, 1000):
        ...
        for v in range(0+f, pipeline.source.num_frames, 4500):
            ...
            if n > pipeline.source.num_frames:
                ...
                #print(common_na)
                smooth_msd(path_line=j,file_2='msd_glass_1_%s_%s_%s_%s.txt'%(i,k,m,n),step=2.0, dump_write=200, step_ovito=1, m=m, n=n) #, common_indices=common_na)
                print('-----------------------------------------------Next calc----------------------------------------------------------')
                print('---------------------------------------------------------------------------------------------------------------------')
