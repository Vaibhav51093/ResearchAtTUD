# The given script is to perform the BENCHMARK test for any system for vasp 
import subprocess;
import os
import shutil
import csv
...
# Inspired by Shared.py by J. M. Skelton
...
# Number of MPI processes. We can play with this number 
NumProcesses = 16;        
