...
# Project 
pr_1 = Project("/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/different_quench/struct_mini")        #! Path for postprocessing 
pr = Project("/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/new_proto_glass/big")   
...
velocity 	    all create 623 {{ rand }} mom yes rot yes dist gaussian
...
for k in strct_no:
    ...
    job_lmp.server.cores = 48             ### The number of cores you want for your job
    job_lmp.run()
    job_lmp.decompress()    
