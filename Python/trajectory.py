...
bins_x            = 300    # number of bins in x direction
bins_y            = 300    # number of bins in y direction
bins_z            = 300   # number of bins in z direction
AtomType          = 4  # Species to be binned
########################################################################################################################################################
