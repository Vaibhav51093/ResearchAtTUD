...
list_file = ['/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/replica_other_1_5/523/dump_nvt_prod_3.out',
             '/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/replica_other_1_5/573/dump_nvt_prod_3.out',
             '/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/replica_other_1_5/623/dump_nvt_prod_3.out',
             '/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/replica_other_1_5/673/dump_nvt_prod_3.out',
             '/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/replica_other_1_5/723/dump_nvt_prod_3.out',
             '/nfshome/deshmukh/vaibhav/shanka_cluster/deshmukh2/replica_other_1_5/773/dump_nvt_prod_3.out',]

# Timesteps
time_step = 2*200 # fs

# File names for saving the PDOS
total_file_name = 'pdos_overall_nasi_1_5_o.png'
na_file_name = 'pdos_na_nasi_1_5_o.png'

# Text file names for saving the max freq
text_file_t = 'max_freq_overall_nasi_1_5_o.txt'
text_file_na = 'max_freq_na_nasi_1_5_o.txt'
