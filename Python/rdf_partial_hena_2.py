...
export_file(pipeline_3, "hena_2_big_glass_623k_partial.txt", "txt/table", key="coordination-rdf[average]")
...
## Data export method 2: Use OVITO's own export function for DataTable objects:
export_file(pipeline_2, "hena_2_big_cryst_623k_partial.txt", "txt/table", key="coordination-rdf[average]")
