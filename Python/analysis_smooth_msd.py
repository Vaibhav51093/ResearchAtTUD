#--------------------------------------------------------------------------------------------------------------------#
# Script by Vaibhav Arun Deshmukh, for rolling average of MSD calculations                                           # 
# TU-Darmstadt, Materials Modelling devision, Materials Science                                                      #
# -------------------------------------------------------------------------------------------------------------------# 
from ovito import *
...
class msd_smooth: 
        ...
        def gb_twist(path = "/home/schulze/simulations/manual-structures/jochen_18/00-minimize/01-heat-523/02-diffusion/",every_animation_frame = 1000,w = 10,filename='diffusivity-attributes-rolling_mean_t'):
        ...
        def gb_tilt(path = "/home/schulze/simulations/manual-structures/jochen_18/00-minimize/01-heat-523/02-diffusion/",every_animation_frame = 1000,w = 10,filename='diffusivity-attributes-rolling_mean_t'):
                ...
                #Export results to txt file
                #k = np.arange(len(Na_MSD_gb), dtype = float)
                #k*=(dt*every_nth_frame)
                #np.savetxt( f"{path}/{filename}.txt", np.column_stack( (k, Na_MSD_gb[:][0], Na_MSD_gb[:][1], Na_MSD_gb[:][2], 
                #                                                                       net_Na_MSD_gb[:][0], net_Na_MSD_gb[:][1], net_Na_MSD_gb[:][2], 
                #                                                                       Na_MSD_com_gb[:][0], Na_MSD_com_gb[:][1], Na_MSD_com_gb[:][2], 
                #                                                                       net_Na_MSD_com_gb[:][0], net_Na_MSD_com_gb[:][1], net_Na_MSD_com_gb[:][2],
                #                                                                       Na_MSD_grain[:][0], Na_MSD_grain[:][1], Na_MSD_grain[:][2], 
        ...
        def box_msd(path="/home/schulze/simulations/manual-structures/jochen_18/00-minimize/01-heat-523/02-diffusion/",every_animation_frame = 1000,filename='diffusivity-attributes-rolling_mean_t.txt'):
                ...
                for i in range(every_nth_frame, half_frame, every_nth_frame):
                    ...
                    k=(i*dt*every_animation_frame)
                    #Export results to txt file
                    np.savetxt( f"{path}/{filename}{k:.0f}.txt", np.column_stack( (k, Na_msd_grain[0], Na_msd_grain[1], Na_msd_grain[2], net_Na_msd_grain[0], net_Na_msd_grain[1], net_Na_msd_grain[2], Na_msd_com_grain[0], Na_msd_com_grain[1], Na_msd_com_grain[2], net_Na_msd_com_grain[0], net_Na_msd_com_grain[1], net_Na_msd_com_grain[2] )), delimiter = " ")#, header = "Timestep(ps),MSDx_gb_raw(A^2),MSDy_gb_raw(A^2),MSDz_gb_raw(A^2),netMSDx_gb_raw(A^2),netMSDy_gb_raw(A^2),netMSDz_gb_raw(A^2),MSDx_gb_com(A^2),MSDy_gb_com(A^2),MSDz_gb_com(A^2),netMSDx_gb_com(A^2),netMSDy_gb_com(A^2),netMSDz_gb_com(A^2),MSDx_grain_raw(A^2),MSDy_grain_raw(A^2),MSDz_grain_raw(A^2),netMSDx_grain_raw(A^2),netMSDy_grain_raw(A^2),netMSDz_grain_raw(A^2),MSDx_grain_com(A^2),MSDy_grain_com(A^2),MSDz_grain_com(A^2),netMSDx_grain_com(A^2),netMSDy_grain_com(A^2),netMSDz_grain_com(A^2)")
