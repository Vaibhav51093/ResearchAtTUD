...
input_files = ["/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/new_ordered_glass/boilot_623K_2_05_amorph_523_k_ps_new_3_hdf5/boilot_623K_2_05_amorph_523_k_ps_new_3/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/new_ordered_glass/boilot_623K_2_05_amorph_573_k_ps_new_3_hdf5/boilot_623K_2_05_amorph_573_k_ps_new_3/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/new_ordered_glass/boilot_623K_2_05_amorph_623_k_ps_new_3_hdf5/boilot_623K_2_05_amorph_623_k_ps_new_3/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/new_ordered_glass/boilot_623K_2_05_amorph_673_k_ps_new_3_hdf5/boilot_623K_2_05_amorph_673_k_ps_new_3/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/new_ordered_glass/boilot_623K_2_05_amorph_723_k_ps_new_3_hdf5/boilot_623K_2_05_amorph_723_k_ps_new_3/dump_nvt_prod.out",
               "/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/new_ordered_glass/boilot_623K_2_05_amorph_773_k_ps_new_3_hdf5/boilot_623K_2_05_amorph_773_k_ps_new_3/dump_nvt_prod.out",]
...
for i,j,k in zip(li,input_files,no):
    ...
    for e in range(0,pipeline.source.num_frames,pipeline.source.num_frames//d):
        if e+pipeline.source.num_frames//5 > pipeline.source.num_frames:
            ...
            print('------------------------------------------------------------------------------------------------------------------')
            smooth_msd(path_line=j,file_2='msd_na_random_%s_%s_%s_%s.txt'%(i,k,m,n),step=1.0, dump_write=100, step_ovito=10, m=m, n=n)
            print('-----------------------------------------------Next calc----------------------------------------------------------')
            print('---------------------------------------------------------------------------------------------------------------------')
