# The given script is to perform the BENCHMARK test for No Proc, KPAR, NPAR, NSIM 
# MPI paralalization with CPU,
#    
...
# OUTCAR, OZICAR and result collector---------------------------------------------------------------------------------------------------# 
...
# Intital parameter to setup 
# Idealy NumProc <= No of atoms, always perform test on those no of proc 

NumProcesses = 16                                         # No of processors (later one can fix it and chnage others)        
TestKPARValues = [1]                                      # KPAR values, default is 1
TestNPARValues = [1, 2, 4, 8, 16]                         # NPAR values 
TestNSIMValues = [1, 2, 4, 8, 12, 16, 24, 32, 48, 64]     # NSIM values 
...
SkipSCFCycles = 5;  # Here we are skiping first 5 SCF cycles 
