...
# Project 
pr_1 = Project("/nfshome/deshmukh/pyiron/projects/NASICON/project/padone_pot/different_quench/ordered/big")           #! Path for postprocessing 
...
for k in strct_no:
    job_mini = pr_1['boilot_623K_1_%s_large_ordered_mini'%k]  # Bulk Crystal
    # Get last structure    
    struct_nvt = job_mini.get_structure(iteration_step=-1)    # Last frame from minimization
    import random
    #ran = random.randrange(49284)
    #ran = random.randrange(49284)
    job_name = 'boilot_663K_2_05_cryt_s_%s_k_ps'%(k)
