...
for i in range(100):
    bulk_struct = ase_to_pyiron(read(filename='/nfshome/deshmukh/vaibhav/schulze_project/gb/order/5_130/new_modified_%s.cif'%(i),format='cif'))
    job_name = 'nasi_5_130_new_m_2_%s'%(i)
