...
def smooth_msd(path_line='dump_nvt_prod.out',file_2='msd_na.txt',step=1.0, dump_write=100, step_ovito=10,m=0,n=1000):
    ...
    # Affine transformation: This step is extremly essential because perpendicular to GB is something else need to rotate 
    #                        actual cell by 30 degree anti-clockwise, to align GB perpedicular to coordinate system x and y and z is constant.  
    pipeline.modifiers.append(AffineTransformationModifier(transformation = [[0.8660254037844387, 0.49999999999999994, 0.0, 0.4935440284431394], [-0.49999999999999994, 0.8660254037844387, 0.0, 22.579394808170484], [0.0, 0.0, 1.0, 0.0]]))
   ...
   # 
    ...
    def modify3(frame: int, data: DataCollection, type_id_Na = 4):
...
input_files = ["/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp06/00-minimize/01-heat-523/02-diffusion/structure.dump.*",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp06/00-minimize/01-heat-573/02-diffusion/structure.dump.*",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp06/00-minimize/01-heat-623/02-diffusion/structure.dump.*",             
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp06/00-minimize/01-heat-673/02-diffusion/structure.dump.*",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp06/00-minimize/01-heat-723/02-diffusion/structure.dump.*",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp06/00-minimize/01-heat-773/02-diffusion/structure.dump.*",]
