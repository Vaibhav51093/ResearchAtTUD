...
def smooth_msd(path_line='dump_nvt_prod.out',file_2='msd_na.txt',step=1.0, dump_write=100, step_ovito=10,m=0,n=1000):
    ...
    def modify1(frame: int, data: DataCollection):
        ...
        charge_dict = { "P": 3.0, "O":-1.2, "Na":0.6}     # Padone charges 
        mass_dict = {  "P": 30.974,
                        "O": 15.999,
                        "Na": 22.99}
...
input_files = ["/nfshome/deshmukh/vaibhav/NaSICON_dft/glass_decompo_lammps/new_glass/na3po4_amorphous_large_lmp_hdf5/na3po4_amorphous_large_lmp/523/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/vaibhav/NaSICON_dft/glass_decompo_lammps/new_glass/na3po4_amorphous_large_lmp_hdf5/na3po4_amorphous_large_lmp/573/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/vaibhav/NaSICON_dft/glass_decompo_lammps/new_glass/na3po4_amorphous_large_lmp_hdf5/na3po4_amorphous_large_lmp/623/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/vaibhav/NaSICON_dft/glass_decompo_lammps/new_glass/na3po4_amorphous_large_lmp_hdf5/na3po4_amorphous_large_lmp/673/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/vaibhav/NaSICON_dft/glass_decompo_lammps/new_glass/na3po4_amorphous_large_lmp_hdf5/na3po4_amorphous_large_lmp/723/dump_nvt_prod.out.gz",
               "/nfshome/deshmukh/vaibhav/NaSICON_dft/glass_decompo_lammps/new_glass/na3po4_amorphous_large_lmp_hdf5/na3po4_amorphous_large_lmp/773/dump_nvt_prod.out.gz"]
...
for i,j,k in zip(li,input_files,no):
    ...
    for f in range(0, pipeline.source.num_frames, 1000):

        for v in range(0+f, pipeline.source.num_frames, 4500):

            m = v
            n = v+5000  # 2 ns interval 
            if n > pipeline.source.num_frames:
                ...
                #print(common_na)
                smooth_msd(path_line=j,file_2='msd_glass_%s_%s_%s_%s.txt'%(i,k,m,n),step=2.0, dump_write=200, step_ovito=1, m=m, n=n) #, common_indices=common_na)
                print('-----------------------------------------------Next calc----------------------------------------------------------')
                print('---------------------------------------------------------------------------------------------------------------------')
