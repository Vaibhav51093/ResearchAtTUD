...
### Parameters ########################################################################################################################################
in_filename       = '/nfshome/deshmukh/pyiron/projects/NASICON/project/hena/hena_2_2/glass/glass_hena_2/glass_6_623/dump_nvt_prod.out'
out_filename      = 'na_big_glass_623k_6.xyz' # There will be scaled RDFs (all partial sum up to the total RDF) and unscaled (as if only those particles were in the box)
