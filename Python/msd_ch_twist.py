...
input_files = ["/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp02/00-minimize/01-heat-523/02-diffusion",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp02/00-minimize/01-heat-573/02-diffusion",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp02/00-minimize/01-heat-623/02-diffusion",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp02/00-minimize/01-heat-673/02-diffusion",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp02/00-minimize/01-heat-723/02-diffusion",
               "/nfshome/deshmukh/vaibhav/schulze_project/gb/IDp02/00-minimize/01-heat-773/02-diffusion",]
...
for element in input_files:
    ...
    for i,j in zip(range(500,3000,500), range(0,2500,500)):    
        ...
        export_file(pipeline, f"{infile}/na_diffusion_tilt_auto_ch_%s.txt"%(j), "txt/attr", columns=["Timestep", "netMSDx_box_com", "netMSDy_box_com", "netMSDz_box_com","netMSDav_box_com"],multiple_frames=True, start_frame=j, end_frame=i)
