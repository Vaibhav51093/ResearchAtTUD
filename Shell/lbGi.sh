...
find /nfshome/deshmukh/vaibhav/frank_jÜlich/lmp_3_1_3/large/simu/simu_2/773/new/ -type f -name "dump_nvt_prod.out.tar.gz" 2>/dev/null | while read -r file; do
    ...
    # Check if only dump_nvt_prod.out.tar.gz exists
    ...
    # Check if only dump_nvt_prod.out exists
