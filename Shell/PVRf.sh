...
srun --mpi=openmpi /home/vd80naku/lammps/lammps/src/lmp_intel_cpu_openmpi -i control.inp
#srun --mpi=intelmpi /home/vd80naku/lammps/lammps/src/lmp_intel_cpu_openmpi -i control.inp
