...
find  /nfshome/deshmukh/pyiron/projects/NASICON/project/ -type f \( -name "dump_nvt_prod.out" -o -name " dump_nvt_prod.out.tar.gz"\) 2>/dev/null | while read -r file;directory; do
    echo "file: $file"
